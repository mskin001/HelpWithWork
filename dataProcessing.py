...
class TicTacToeGame:
    ...
    def _setup_board(self):
        self._current_moves = [[Move(row,col) 
    ...
    def _get_winning_combos(self):
        ...
        second_diag = [col[j] for j, col in enumerate(reversed(columns))]
        return rows + columns + [first_diag, second_diag]
    ...
    def is_tied(self):
        no_winner = not self._has_winner
        played_moves = (move.label for row in self._current_moves
                        for move in row)
...
class TicTacToeBoard(tk.Tk):
    ...
    def _create_board_display(self):
        ...
        self.display = tk.Label(master=display_frame, text="Choose!",
